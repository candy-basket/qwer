...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	public interface TabSwipeSelector{
		public void setAction(int position, LinearLayout tabsContainer);
	}
	
	public void setCallback(TabSwipeSelector mCallback){
	...
	private int underlineColor = 0xFFE3E3E3; //TODO »ö¹Ù²Þ
	...
	private class PageListener implements OnPageChangeListener {
		...
		public void onPageSelected(int position) {
			//TODO::
			if(mCallback != null){
				mCallback.setAction(position, tabsContainer);
			}

 ...
 * @date 2013-10-22
 * <pre>
 * 상속받는 클래스가 ImageView였는데, NetworkImageView 로 교체 Volley를 사용하기 위해서
 * </pre>
 */
public class ViewTouchImage extends NetworkImageView implements OnTouchListener{

    private static final String TAG = ViewTouchImage.class.getSimpleName();
